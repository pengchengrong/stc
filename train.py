...
def train(max_iter, batch_size=8, log_dir=None, aggre = None):
	...
	if aggre is not None:
		train_dataloader = load('train', num_workers=0, batch_size=batch_size, crop=64, subset = aggre)
	else:
		train_dataloader = load('train', num_workers=0, batch_size=batch_size, crop=64)
